...
<section class="content">
    <div class="box">
        <div class="box-body">
            <?php if(!empty($kamar_tersedia) || !empty($kamar_vc)) { ?>
            <div class="row">
                <?php foreach(array_merge($kamar_tersedia, $kamar_vc) as $kamar_tersedia) { ?>
                <div class="col-sm-3">
                    <div class="small-box bg-green">
                        ...
                        <a class="small-box-footer"
                            href="?module=transaksi/checkin-add&kamar=<?php echo $kamar_tersedia['id_kamar']; ?>">Pilih
                            Kamar</a>
                    </div>
                </div>
                <?php } ?>
