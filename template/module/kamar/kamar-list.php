                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
							...
							?>
                            <span
                                class="badge bg-<?php echo $status_kamar; ?>"><?php if ($kamar['status_kamar']=='TERSEDIA') echo 'AVAILABEL'; else if ($kamar['status_kamar']=='TERPAKAI') echo 'OO'; else if ($kamar['status_kamar']=='KOTOR') echo 'VD'; ?></span>
                        </td>
                        <td>
