        ...
        <div class="box">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="nomor_kamar"
                                value="<?php echo $kamar_view['nomor_kamar']; ?>" />
                        </div>
                        <div class="form-group">
                            <label>Tipe Kamar</label>
                            <input class="form-control" value="<?php echo $kamar_view['nama_kamar_tipe']; ?>"
                                disabled />
                            <select class="form-control" name="id_kamar_tipe">
                                ...
                                <option value="<?php echo $kamar_tipe['id_kamar_tipe']; ?>">
                                    <?php echo $kamar_tipe['nama_kamar_tipe']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" value="<?php echo $kamar_view['max_dewasa']; ?> Orang"
                                disabled />
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status_kamar">
                                ...
                                <option value="OS">OS/OUT OF SERVICE</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="box-footer">
                ...
                <a class="btn btn-danger"
                    href="?module=kamar/kamar-delete&kamar=<?php echo $kamar_view['id_kamar']; ?>">Hapus Kamar</a>
