...
<section class="content-header">
    <h1>Dashboard <span class="small">Selamat datang di E-DOTEL
        </span></h1>
</section>
    ...
    <div class="row">
                ...
                <div class="box-body">
                    ...
                    <table class="table table-sriped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $tamu_inhouse['prefix'].'. '.$tamu_inhouse['nama_depan'].'&nbsp;'.$tamu_inhouse['nama_belakang']; ?>
                                </td>
                                <td><?php echo $tamu_inhouse['nomor_kamar']; ?></td>
                                <td><?php echo $tamu_inhouse['tanggal_checkin'].' - '.$tamu_inhouse['waktu_checkin']; ?>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Berita / Pengumuman Internal <span class="small">sedang dalam
                            pengembangan</span></h3>
                </div>
                <div class="box-body">
