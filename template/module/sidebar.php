    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="?module=transaksi/pesan-layanan"><i class="fa fa-circle-o"></i> Pesan Layanan /
                            Produk</a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="?module=laporan/transaksi-layanan"><i class="fa fa-circle-o"></i> Transaksi Layanan</a>
                    </li>
                    <li><a href="?module=laporan/grafik"><i class="fa fa-circle-o"></i> Grafik</a></li>
                </ul>
            </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="template/module/export/transaksi_checkout.php"><i class="fa fa-circle-o"></i> Transaksi
                            Check In/Out</a></li>
                    <li><a href="template/module/export/transaksi_layanan.php"><i class="fa fa-circle-o"></i> Transaksi
                            Layanan</a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="?module=perusahaan/perusahaan"><i class="fa fa-circle-o"></i> Lihat / Update
                            Perusahaan</a></li>
                </ul>
            </li>
            <?php } } ?>
